    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_status', models.BooleanField(help_text='Whether the transaction was approved or not')),
                ('notice_message', models.CharField(blank=True, help_text='Any error or warning messages from Helcim', max_length=128, null=True)),
